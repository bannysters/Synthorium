...
if ROBLOX then
    ...
    local roof = Instance.new("Part", mapModel)
    roof.Size = Vector3.new(map_size, 1, map_size)
    roof.Position = Vector3.new(map_vectors[1][1][1], 1, map_vectors[1][1][2])
    roof.Anchored = true
    roof.Transparency = 0.5

    mapModel.Parent = game.ServerStorage
else
